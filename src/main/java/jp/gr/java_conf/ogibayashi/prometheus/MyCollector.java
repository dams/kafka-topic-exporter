 ...
 */
public abstract class MyCollector {
  /**
   ...
   */
  public <T extends MyCollector> T register() {
    return register(MyCollectorRegistry.defaultRegistry);
  }

  /**
   * Register the Collector with the given registry.
   */
  public <T extends MyCollector> T register(MyCollectorRegistry registry) {
